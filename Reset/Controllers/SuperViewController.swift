...
class SuperViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        support.tabBarItem = UITabBarItem(title: "Home", image: UIImage(systemName: "figure.2"), tag: 1)
        
        let community = UIStoryboard(name: "Community", bundle: nil).instantiateInitialViewController()!
        community.tabBarItem = UITabBarItem(title: "Home", image: UIImage(systemName: "person.3.fill"), tag: 2)
